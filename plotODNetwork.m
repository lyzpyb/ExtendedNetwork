function [handle_fig,handle_txt] = plotODNetwork(nodes,linksCopy_order,show_label,fig_num)
%Plot a network
%
%
%SYNTAX
%   [handle] = PLOTODNETWORK(nodes,links,scale) 
%
%DESCRIPTION
...
strN = linksCopy_order.link_o;
endN = linksCopy_order.link_d;
x=nodes.xco;
y=nodes.yco;
...
title('Extended Network for RS driver')
xlabel('X coordinate')
ylabel('Y coordinate')
